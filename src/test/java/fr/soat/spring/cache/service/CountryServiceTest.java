...
import fr.soat.spring.cache.util.CoherenceCacheServerWrapper;
...
public class CountryServiceTest {
	...
	public void testRetrieveGrossNationalHappiness() throws Exception {
		...
		Integer firstTemperature = service.retrieveGrossNationalHappiness(country);
		// Second call, the web-service is not expected to be called
		Integer secondTemperature = service.retrieveGrossNationalHappiness(country);
